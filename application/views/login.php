...
<head>
  ...
  <title>Carnet Digital - Ingreso</title>
                ...
                <div class="p-5">
                  ...
                  <form class="user">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Ingrese direccion de correo...">
                    </div>
                    <div class="form-group">
